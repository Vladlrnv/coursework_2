class Vacancy:
    ...
    def __init__(self, name, alternate_url, salary, requirement):
        """Метод инициализации аргументов класса"""
        self.name = name
    ...
    def __str__(self):
        """Метод вывода информации о вакансии для пользователя"""
    ...
    def cast_to_object_list(cls, vacancies: list):
        """Метод для записи вакансий в словарь"""
        new_list = []
    ...
    def __repr__(self):
        """Метод для вывода информации о вакансии для разработчика"""
    ...
    def __isinstance_data(cls, other):
        """Метод для проверки входящих данных на принадлежность к классу Vacancy"""
    ...
    def __eq__(self, other):
        """Метод для определения равенства и неравенства вакансий по зарплате"""
        sal_1 = self.__isinstance_data(other)
        return self.salary == sal_1

    def __lt__(self, other):
        """Метод для сравнения вакансий операторами 'больше' и 'меньше'"""
        sal_2 = self.__isinstance_data(other)
        return self.salary < sal_2

    def __le__(self, other):
        """Метод для сравнения вакансий операторами 'больше или равно' и 'меньше или равно'"""
